...
mkdir -p out/@tensorflow/tfjs-node/lib/napi-v3
...
cp -RL ../../node_modules/@tensorflow/tfjs-node/lib/napi-v3/* out/@tensorflow/tfjs-node/lib/napi-v3 || { echo "tfjs not built!"; exit 1; }
